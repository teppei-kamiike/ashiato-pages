...
## 第2条（個人情報の収集方法）
1. 当方は，メッセージ生成ツールとしてChat Completions API(OpenAI Inc.)を本アプリ内から利用しています。ユーザが本アプリ内に保存したデータの一部をChat Completions APIに渡すことでメッセージを生成しています。OpenAI社での個人情報の取り扱いについては以下のOpenAIプライバシーポリシーのリンクよりご確認ください。
